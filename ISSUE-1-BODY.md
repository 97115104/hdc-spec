...
## What AIISP-1 specifies, in one paragraph
...
This thread is open indefinitely. Substantive comments received **on or before 2026-06-22** will be reflected in AIISP-1 v0.2, which will be circulated as a separate issue with a diff against v0.1. Earlier amendments may land in interim editorial drafts; see [`CHANGELOG.md`](https://github.com/97115104/aiisp-spec/blob/main/CHANGELOG.md).

---

## Disclosure

The editor (Austin Harshberger) is the principal of Happy Stack Calculus LLC, which intends to operate the reference implementation of AIISP-1 and to act as the initial on-chain settlement infrastructure operator. This is a present and ongoing conflict of interest. The medium-term plan, documented in [`GOVERNANCE.md`](https://github.com/97115104/aiisp-spec/blob/main/GOVERNANCE.md), is to migrate ratification authority for AIISP-1 v1.0 and beyond to a multi-stakeholder body before the standard is declared stable. The editor's compensation, once any settlement flows exist, will be published on the same on-chain ledger as contributor compensation.
...
@misc{aiisp1spec2026,
  ...
  note         = {Draft v0.1; public review at \url{https://github.com/97115104/aiisp-spec/issues/1}}
}
```
