...
\twocolumn[{%
\begin{center}
{\LARGE\bfseries The Human Data Collective:\\[3pt]A Standard for Open, Sustainable,\\[2pt]and Equitable Machine Intelligence\par}
\vspace{6pt}
...
\vspace{4pt}
\begin{center}
{\scriptsize\bfseries Figure i. Human Data Collective architecture}\\[5pt]
...
\begin{center}
\rule{0.25\textwidth}{0.4pt}\\[4pt]
{\itshape with gratitude}\\[4pt]
...
\scriptsize
\textbf{attest} \texttt{v3.0} \hfill \texttt{2026-04-22-77bcda}\\[2pt]
\textit{Human--AI collaboration.}\\[2pt]
{\renewcommand{\arraystretch}{0.9}%
\begin{tabular}{@{}lp{0.56\textwidth}@{}}
\textbf{Content} & The Human Data Collective \\
\textbf{Author} & A.~Harshberger \\
\textbf{Model/tooling} & Claude Opus 4.7, Gemini 3.1 Pro (Preview), GitHub Copilot in VS Code \\
\textbf{Role} & human-directed drafting, citation lookup, \LaTeX{} formatting, and revision support \\
\textbf{Method} & multi-prompt iterative authoring with human-selected structure, argument, and final wording \\
